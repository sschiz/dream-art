	...
	if update.Message != nil {
		...
		if update.Message.IsCommand() {
			...
			case "buy":
				...
				msg.ParseMode = "markdown"
			case "start":
				msg.Text = "🖼 Чтобы рассчитать стоимость будущего портрета, нужно всего лишь выбрать его стиль и размерю \n\n" +
					"Напиши /buy, чтобы начать и получить свой скидочный купон. Ведь всегда приятно сохранить денюжку 😉"
